...
export const A0_LES_06: Lesson = {
  ...
  estimatedMinutes: 13,
  coverage: ['§2.11', '§2.13', '§3.7', '§4'],
  prerequisites: ['a0-les-05'],
  reviewWords: [
    { nl: 'wie', en: 'who' },
    { nl: 'wat', en: 'what' },
    { nl: 'hoe', en: 'how' },
    { nl: 'hij', en: 'he', partOfSpeech: 'pronoun' },
    { nl: 'zij', en: 'she / they', partOfSpeech: 'pronoun' },
    { nl: 'ze', en: 'she / they (unstressed)', partOfSpeech: 'pronoun' },
    { nl: 'het', en: 'it', partOfSpeech: 'pronoun' },
    { nl: 'wij', en: 'we (emphasized)', partOfSpeech: 'pronoun' },
    { nl: 'we', en: 'we', partOfSpeech: 'pronoun' },
    { nl: 'jullie', en: 'you (plural)', partOfSpeech: 'pronoun' },
    { nl: 'jij', en: 'you (informal, emphasized)' },
    { nl: 'je', en: 'you (informal)' },
    { nl: 'jouw', en: 'your (informal)' },
    { nl: 'zijn', en: 'his', partOfSpeech: 'pronoun', srsKey: 'zijn-possessive' },
    { nl: 'haar', en: 'her', partOfSpeech: 'pronoun', srsKey: 'haar-possessive' },
    { nl: 'ons', en: 'our (with het-words)', partOfSpeech: 'pronoun' },
    { nl: 'onze', en: 'our (with de-words and plurals)', partOfSpeech: 'pronoun' },
    { nl: 'hun', en: 'their', partOfSpeech: 'pronoun' },
    { nl: 'u', en: 'you (formal)' },
