...
export const A0_LES_05: Lesson = {
  ...
  sections: [
    ...
    },
    {
      ...
      payload: {
        intro:
          'Identiteit in korte zinnen: naam, land, taal, werk en rol. "Heten" is een werkwoord ("to be called"); je hoort het als "ik heet" — over conjugatie van heten gaat het in een latere les.',
        words: [
          {
            nl: 'ik',
            en: 'I',
            partOfSpeech: 'pronoun',
            exampleNl: 'Ik ben Anna.',
            exampleEn: 'I am Anna.',
          },
          {
            nl: 'mijn',
          ...
          },
          {
            ...
            en: 'country',
            gender: 'het',
            exampleNl: 'Nederland is een land.',
            exampleEn: 'The Netherlands is a country.',
          },
          {
            nl: 'mijn naam is',
            en: 'my name is',
          ...
          },
          {
            ...
            en: 'Dutch',
            partOfSpeech: 'phrase',
            exampleNl: 'Ik spreek een beetje Nederlands.',
            exampleEn: 'I speak a little Dutch.',
          },
          {
            nl: 'Engels',
            en: 'English',
            partOfSpeech: 'phrase',
            exampleNl: 'Ik spreek Engels.',
          ...
          },
          {
            ...
            en: 'nationality',
            gender: 'de',
            exampleNl: 'Mijn nationaliteit is Nederlands.',
            exampleEn: 'My nationality is Dutch.',
          },
          {
            nl: 'werk',
            en: 'work',
            gender: 'het',
            exampleNl: 'Mijn werk is in Amsterdam.',
            exampleEn: 'My work is in Amsterdam.',
          },
          {
            nl: 'student',
            en: 'student',
          ...
          },
          {
            ...
            en: 'teacher (male)',
            gender: 'de',
            exampleNl: 'De leraar heet Tom.',
            exampleEn: 'The teacher is called Tom.',
          },
          {
            nl: 'lerares',
            en: 'teacher (female)',
            gender: 'de',
            exampleNl: 'De lerares heet Anna.',
            exampleEn: 'The teacher is called Anna.',
          },
        ],
      },
    },
