...
export default function LuisterenReviewPage() {
  const attempts = useLiveQuery(
    () => db.listeningAttempts.orderBy('submittedAt').reverse().toArray(),
    [],
  );
  ...
  return (
    <div className="space-y-5">
      <header>
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight">Luisteren</h1>
      </header>
      ...
      {attempts === undefined ? (
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">
          Nog geen luistervragen beantwoord.
        </p>
      ) : (
